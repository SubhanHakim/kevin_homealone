            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
                {SUPPORTERS.map((member) => (
                    <a
                        ...
                        className="relative bg-white border-2 border-[#1A1B4B] p-6 rounded-xl shadow-[6px_6px_0px_0px_rgba(11,14,35,1)] hover:shadow-[10px_10px_0px_0px_#3B82F6] hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center group last:col-span-2 lg:last:col-span-1 w-full max-w-sm mx-auto lg:max-w-none cursor-pointer"
                    >
