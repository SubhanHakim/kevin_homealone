...
export const Footer = () => (
    <footer className="bg-[#0B0E23] text-white/50 text-center py-8 text-sm border-t border-white/10">
        <div className="flex justify-center gap-6 mb-4 items-center">
            {/* X (Twitter) Icon */}
            <a href="https://x.com/i/communities/2004125957670703260" className="hover:text-white transition-colors" aria-label="X (Twitter)">
            ...
            {/* DexScreener Icon */}
            <a href="https://pump.fun/coin/2iRcDWDrTJVpbDzjgmsAL7WatTQZEg9xkB3vDGzGpump" className="hover:text-white transition-transform hover:scale-110" aria-label="DexScreener">
